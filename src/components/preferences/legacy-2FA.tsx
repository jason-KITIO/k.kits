      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <Alert className="border-amber-200 dark:border-amber-800 bg-amber-50 dark:bg-amber-900/20">
          ...
          <AlertDescription className="text-amber-800 dark:text-amber-200">
            ...
            >
              Configurez l&apos;authentification multifacteur (MFA) pour votre
              compte ici .
            </a>
          </AlertDescription>
        </Alert>
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg hover:bg-muted/50 transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Code par message</p>
                    </div>
                  </div>
        ...
        {is2FAEnabled && (
          <Card className="border-0 shadow-md hover:shadow-lg transition-shadow duration-200">
            ...
            <CardContent>
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 p-6 bg-muted/50 rounded-lg">
                <div className="flex-1">
                  <p className="text-foreground mb-2">
                    Utilisez le bouton à droite pour modifier votre numéro,
                    changer de méthode d&apos;authentification ou générer des
