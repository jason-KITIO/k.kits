...
export default function NewSupplierPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await storeService.createSupplier(organizationId, storeId, formData);
      toast.success("Fournisseur créé avec succès");
      router.push(`/preferences/organizations/${organizationId}/stores/${storeId}/suppliers`);
    } catch (error) {
    ...
    <div className="space-y-6 p-6">
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="sm" asChild>
          <Link href={`/preferences/organizations/${organizationId}/stores/${storeId}/suppliers`}>
